defmodule HTMLAssertion.Parser do
  @moduledoc false
  ...
  """
  @spec find(HTMLAssertion.html(), HTMLAssertion.css_selector()) :: html_tree
  ...
  """
  @spec attribute(HTMLAssertion.html(), String.t()) :: String.t() | nil
  ...
  @spec text(HTMLAssertion.html()) :: String.t()
